...
namespace MvcDemo.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Prod_name,Category_id,Brand_id,Quantity,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Prod_name,Category_id,Brand_id,Quantity,Price")] Product product)
        {
            if (ModelState.IsValid)
            {
